...
const CATEGORIAS = [
  `${BASE}/57-FERRAMENTAS/65-FERRAMENTAS-MANUAIS`,
  `${BASE}/57-FERRAMENTAS/64-FERRAMENTAS-COM-FIO`,
  `${BASE}/57-FERRAMENTAS/61-FERRAMENTAS-A-BATERIA`,
  `${BASE}/57-FERRAMENTAS/60-CABOS-E-CARREGADORES`,
  `${BASE}/57-FERRAMENTAS/59-EXTENCOES-FILTRO-E-LINHAS`,
  `${BASE}/55-VARIEDADES/75-UTILIDADES-DOMÉSTICAS`,
  `${BASE}/55-VARIEDADES/56-PILHAS-E-BATERIAS`
];
